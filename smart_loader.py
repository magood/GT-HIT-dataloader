...
fhirbase = 'https://fhir-open-api-dstu2.smarthealthit.org'
#fhirheaders = {'Content-Type': 'application/json+fhir;charset=utf-8'}
...
def mapmuse_to_org(mm, otype):
    ...
    if addr and mm['lat'] and mm['lng']:
        ...
        addr['text'] = json.dumps(text_hack)
...
if __name__ == '__main__':
    ...
    #remove_orgs('rails2trails')
    #remove_orgs('ymca')
    #test_post()
    #delete_org("5722b1af0cf20e9addb273dd")